...
const html=`<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Last Bastion — World Lab</title><style>${css.css}</style></head><body><div id="root"></div><script>${js}</script></body></html>`;
